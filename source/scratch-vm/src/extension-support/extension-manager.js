...
const builtinExtensions = {
    ...
    cdtnKidsuino: () => require('../extensions/scratch3_cdtn_kidsuino'),
    ...
    //CDTN build problems   openai: () => require('../extensions/scratch3_openai'),
    ...
    //CDTN build problems    llmstudio:() => require('../extensions/scratch3_llmstudio'),
